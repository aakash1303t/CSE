  ...
  return (
    <div className="python-lab-page bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center uppercase">Computer Lab - II (CCC Lab) </h1>
        ...
        The Wi-Fi facility is available inside the laboratory for the benefit of UG and  Ph.D. students to use their own laptops. The centre remains open from morning 9.00 am to 5.00 pm on all working days. The Common Computer Centre provides video-conferencing facility for conducting job placements for students in core companies and also supports the online test being conducted by the companies. Since its inception Computer Lab - II (CCC Lab) is being maintained by the Department of Computer Science and Engineering
        </p>
